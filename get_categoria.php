<?php
	...
	$categoria_pessoa = $_POST['categoria_pessoa'];
	...
	$sql.= " WHERE u.categoria like '%$categoria_pessoa%' AND u.id <> $id_usuario ";
	...
	if($resultado_id){
		...
		while($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
			echo '<a href="#" class="list-group-item">';
				echo '<strong>'.$registro['categoria'].'</strong> <small> - '.$registro['usuario'].'</small>';
				echo '<small> - Telefone: '.$registro['telefone'].'</small>';
